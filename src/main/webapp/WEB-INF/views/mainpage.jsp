...
<body>
	...
	<div id="container">
		<div class="header">
			<header class="header_tit">
				<h1 class="logo">
					<a href="https://m.naver.com/" class="lnk_logo none_link" title="네이버">
						<span class="spr_bi ico_n_logo">네이버</span>
					</a>
					<a href="./myreservation.html" class="lnk_logo none_link" title="예약">
						<span class="spr_bi ico_bk_logo">예약</span>
					</a>
				</h1>
				<a href="./bookinglogin.html" class="btn_my none_link">
		...
		<div class="event">
					...
					<div class="container_visual">
						...
						<div>
							<div class="container_visual">
								...
								<div class="visual_img" id="visual_lst"></div>
							</div>
			...
			<div class="section_event_tab">
				<ul class="event_tab_lst tab_lst_min" id="category_lst">
	...
	<script type="rv-template" id="poromotion_template">
        <div style="background-image:url('{{productImageUrl}}')" class="{{classId}}"></div>
    </script>
	<script type="rv-template" id="product_template">
	    <li class="item">
	        <a href="" class="item_book none_link">
	            <div class="item_preview">
	                <img alt="{{productDescription}}" class="img_thumb" src="{{productImageUrl}}"> <span class="img_border"></span>
	            </div>
	            <div class="event_txt">
